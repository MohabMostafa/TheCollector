...
run "python srcs/original_scripts/_lang_id.py"

step-5 [dialect-id environment]
filter files based on dialect ECA/MSA using _dialect_id.py

run "python srcs/original_scripts/_dialect_id.py"
...
run "python srcs/original_scripts/_mixed_arabic_extractor.py [ECA,MSA]"

step-7 [the-collector environment]
prepare data using _prepare_data.py

run "python srcs/original_scripts/_prepare_data.py [ECA,MSA]"